...
var jiraNumber ='GCMSQABANG-3679';
...
beforeAll(function () {
	...
	/*
     *TC05 - Relationships - Add Relationships - Missing new unit

     */

    it('TC05 - Relationships - Add Relationships - Missing new unit.'+jiraNumber, function () {
      ...
      relationshippage.sendValueTo(loadedData.TargetPanel,loadedData.PartField,loadedData.part);
        ...
        var add = relationshippage.isAddButtonEnaled();
