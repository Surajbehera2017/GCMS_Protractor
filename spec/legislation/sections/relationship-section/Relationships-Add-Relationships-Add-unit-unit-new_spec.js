...
var jiraNumber ='GCMSQABANG-3675';
...
afterEach(function(){
	...
	relationshippage.clickOnIcon('collector','deleteRela');
        ...
        //TC01 - Relationships - Add Relationships - Add from unit to unit


    it('Relationships - Add Relationships - Add from unit to unit.'+jiraNumber, function () {
