...
var jiraNumber ='GCMSQABANG-2077';
...
beforeAll(function () {
	...
	/*
	 * 04 - wrong marginal nro in target
	 */
	it('Relationships - Add Relationships - wrong marginal nro in target.'+jiraNumber, function () {
		...
		expect(relationshippage.getMessageFromInfoDialogueBox()).toContain(loadedData.invalid_margin_error);
