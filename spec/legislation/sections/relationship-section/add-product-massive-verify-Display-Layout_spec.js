...
var jiraNumber ='GCMSQABANG-1974';
...
beforeAll(function () {
	...
	/*
	 * TC08 -Relationships - Add product massive - Aranzadi - Display - Layout
	 */
	it('Relationships - Add product massive - Aranzadi - Display - Layout.'+jiraNumber, function () {
		...
		//Verify add product popup layout: header, content, dropdown
