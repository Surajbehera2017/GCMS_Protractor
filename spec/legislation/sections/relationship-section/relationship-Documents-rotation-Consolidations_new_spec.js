...
var jiraNumber ='GCMSQABANG-2188';
...
afterEach(function(){
   ...
   relationshippage.clickandSelect(loadedData.TypeField,loadedData.relation_type);
	  ...
	  //add unit and date to source
	  relationshippage.sendValueTo(loadedData.SourcePanel,loadedData.UnitField,loadedData.unit);
	  relationshippage.sendValueTo(loadedData.SourcePanel,loadedData.PartField,loadedData.part);
	  relationshippage.sendValueTo(loadedData.SourcePanel,loadedData.DateField,loadedData.date);
