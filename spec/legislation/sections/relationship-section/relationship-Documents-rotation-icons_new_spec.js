...
var jiraNumber ='GCMSQABANG-2192';
...
beforeAll(function () {
	 ...
	 */
	it('Relationships -Documents rotation - icons.'+jiraNumber, function () {
	...
	relationshippage.sendValueTo(loadedData.TargetPanel,loadedData.NumberField,loadedData.number);
		...
		//Verify source eye icon is visible & target eye is hidden
	...
	browser.waitForAngular();
		...
		expect(relationshippage.isTargetDocumentEyeIconDisplayed()).toEqual(false);
