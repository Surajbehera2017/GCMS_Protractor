...
var jiraNumber ='GCMSQABANG-3572';
var jiraNumber1='GCMSQABANG-1934';
...
*/   
  ...
  it('Filter-TargetDate by %%.'+jiraNumber, function () {
    ...
    browser.waitForAngular();
    browser.waitForAngular();
    relationshippage.filterbytargetdate(loaded.wildcardtext);
    browser.waitForAngular();
    ...
    it('Filter-TargetDate by no space.'+jiraNumber1, function () {
      browser.waitForAngular();
      ...
      browser.waitForAngular();
      browser.waitForAngular();
      relationshippage.filterbytargetdate(loaded.emptytext);
      browser.waitForAngular();
      var sourceelementpresent=globalpo.isElementPresent(loaded.sourceelement);
      expect(sourceelementpresent).toEqual(true);
      browser.waitForAngular();
