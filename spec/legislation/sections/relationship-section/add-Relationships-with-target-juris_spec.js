...
var jiraNumber = 'GCMSQABANG-2074';
...
describe('Relationship', function () {
	 ...
	 * 01-Target Juris
	 */
	it('Relationships - Add Relationships - Target Juris.' + jiraNumber, function () {
		...
		//verify if structureicon is disabled or not for target

		expect(relationshippage.isIconEnabled(loadedData.structureIconTarget)).toEqual(false);

		//verify if plus icon is disabled or not for target

		expect(relationshippage.isIconEnabled(loadedData.plusIconTarget)).toEqual(false);

		//verify if unit unittext icon is disabled or not for target
