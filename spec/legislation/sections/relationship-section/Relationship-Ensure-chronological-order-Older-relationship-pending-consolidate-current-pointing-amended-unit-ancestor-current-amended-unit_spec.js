...
var jiraNumber = 'GCMSQABANG-2260';
...
describe('Relationship', function () {
    ...
    //TC02 - Ensure chronological order - Older relationship that is pending to consolidate - current pointing to an amended-unit + older pointing to an ancestor of current amended-unit

    it('Ensure chronological order - older pointing to an ancestor of current amended-unit - one.'+jiraNumber, function () {
