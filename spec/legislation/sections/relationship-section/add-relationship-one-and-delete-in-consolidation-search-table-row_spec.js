...
var jiraNumber = 'GCMSQABANG-2263';
...
describe('Relationship', function () {
	...
	//TC01 - Create a non consolidated relationship and delete in the result table of consolidation

	it('Create one non consolidated relationships and delete in the result table.'+jiraNumber, function () {
		...
		//click on '...' icon next to the row and select delete option
		 relationshipsearch.selectActionFromDropdown(loaded.unit_name,loaded.delete_action);
