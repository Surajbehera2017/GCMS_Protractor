...
var jiraNumber ='GCMSQABANG-3567';
...
describe('Relationship', function () {
	...
	/*
	 * Relationships -check the order data retrieved-Consolidations by source and target
	 */
	it('Relationships -check the order data retrieved-Consolidations by source and target.'+jiraNumber, function () {
...
expect(relationshippage.isDataPresentInRelationshipContainer()).toEqual(true);
 ...
 browser.waitForAngular();
//Open consolidation-target relations from relationship section
globalpage.expandSectionInLeftPanel(loadedData.Relationships);
browser.waitForAngular();
relationshippage.clickOnSoureOrTargetOf(loadedData.consolidations,loadedData.Target);
...
relationshippage.clickOnSoureOrTargetOf(loadedData.consolidations,loadedData.Source);
browser.waitForAngular();
//Verify relationship table & order data is displayed
expect(relationshippage.isRelationshipContainerDisplayed()).toEqual(true);
expect(relationshippage.isDataPresentInRelationshipContainer()).toEqual(true);
