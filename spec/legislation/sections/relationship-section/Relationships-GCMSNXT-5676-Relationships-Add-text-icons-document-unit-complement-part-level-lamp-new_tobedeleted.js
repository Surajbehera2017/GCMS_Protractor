...
describe('Relationship', function () {
	...
	/*
     *  GCMSNXT-5676 Relationships - Add from text icons-from document unit-complement  part level-lamp
     */

    it('GCMSNXT-5676 Relationships - Add from text icons-from document unit-complement  part level-lamp', function () {
        ...
        browser.sleep(4000);
        relationshippage.sendKeystoTypeinRelationshipTab(loadedata.GCMS_NXT.text_type_one);
        browser.waitForAngular();
