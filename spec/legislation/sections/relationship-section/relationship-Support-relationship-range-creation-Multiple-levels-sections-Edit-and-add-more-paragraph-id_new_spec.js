...
var jiraNumber ='GCMSQABANG-2285';
...
describe('Relationship', function () {
	...
	/*
	 * TC03 - Relationships - Support relationship range creation - Multiple levels-sections - Edit and add more paragraph id
	 */
	it('Relationships - Support relationship range creation - Multiple levels-sections - Edit and add more paragraph id.'+jiraNumber, function () {
		...
		globalpage.clickOnButtonForGlobal('Ok');
		 ...
		 //Click on + button next to anchor image again & select 1 more paragraph ids
		 relationshippage.clickOnIcon(loadedData.SourcePanel,loadedData.PlusIcon);
