...
var jiraNumber = 'GCMSQABANG-2177';
...
describe('Relationship', function () {
	...
	/*
	 * TC03 - Relationships - Add Relationships - Aceptaciones - Adhiere - Required fields
	 */
	it('Relationships - Add Relationships - Aceptaciones - Adhiere - Required fields.' + jiraNumber, function () {

		// click on add button on relationship section 
		globalpage.clickOnSectionButton(loadedData.Relationships, loadedData.AddButton);


		//Verify type as Adhiere 
