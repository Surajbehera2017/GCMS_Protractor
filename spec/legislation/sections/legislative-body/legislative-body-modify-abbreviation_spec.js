...
var jiraNumber = 'GCMSQABANG-2356';
...
describe('Legislation-Body', function () {
	...
	it('should modify enter the abbreviation.'+jiraNumber,function (){
        
        global.expandSectionInLeftPanel('Statute Data');
        expect(legislativebodyEdition.isExpanded()).toEqual(true);
        legislativebodyEdition.ClickabbrevationList();
        legislativebodyEdition.modifyAbbreviation(loadedData.modify_abbreviation);
