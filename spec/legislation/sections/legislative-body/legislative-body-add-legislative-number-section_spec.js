...
var jiraNumber='GCMSQABANG-2350';
...
describe('Legislation-Body', function () {
    ...
    it('should add legislattive number section after last legislattive number.'+jiraNumber, function () {


        global.expandSectionInLeftPanel('Statute Data');
        expect(legislativebodyEdition.isExpanded()).toEqual(true);
        legislativebodyEdition.ClicklegisNumberButton();
        expect(legislativebodyEdition.haslegisNumberconnectorComboBox()).toEqual(true);
        ...
        legislativebodyEdition.legisNumber(loadedData.legis_num);

        // if (params.BU != 'gulf') {
        //     legislativebodyEdition.legispreviousNote(loadedData.legis_previousNote);
        //     legislativebodyEdition.legisNote(loadedData.legis_note);
        // }

        legislativebodyEdition.legisYear(loadedData.legis_year);
    ...
    afterEach(function () {
        ...
        legisDocEditPage.get(loadedData.marginal_id);
        global.expandSectionInLeftPanel('Statute Data');
        legislativebodyEditionNew.deletePerticularNode(loadedData.delete);
        LegislationDocumentEditionPageObject.saveWIConfirm();
        legislativebodyEditionNew.clickOnButtonConfirmationPopUp("Save");
    });
});
