...
var jiraNumber='GCMSQABANG-2357';
...
describe('Legislation-Body', function () {
	...
	it ('should modify enter the alias .'+jiraNumber,function (){
		
        global.expandSectionInLeftPanel('Statute Data');
        browser.sleep(4000)
        expect(legislativebodyEdition.isExpanded()).toEqual(true);
        browser.sleep(2000);
        var Aliasname = "Alias name" + new Date().toLocaleString();
        legislativebodyEdition.modifyAlias(Aliasname);
