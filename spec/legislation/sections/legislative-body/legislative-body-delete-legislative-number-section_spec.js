...
var jiraNumber='GCMSQABANG-2355';
...
it ('should delete last legislative number section.'+jiraNumber,function (){
		
		
    global.expandSectionInLeftPanel('Statute Data');
    expect(legislativebodyEdition.isExpanded()).toEqual(true);
    //legislativebodyEdition.deletelegisNumber();
   // LegislationDocumentEditionPageObject.save();
   legislativebodyEditionNew.deletePerticularNode("delete-comosition-0-0");
