...
var jiraNumber='GCMSQABANG-3024';
...
it ('should modify the old provisondate sub section.'+jiraNumber,function (){
    
    legislativebodyEdition.expandSection();
    expect(legislativebodyEdition.isExpanded()).toEqual(true);
    legislativebodyEdition.provisonDateEditBox(loadedData.modify_provisonDate);
