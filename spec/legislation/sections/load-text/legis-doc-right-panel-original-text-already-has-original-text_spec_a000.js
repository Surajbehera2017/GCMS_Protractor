...
describe('Legislation Document Display - Load Text section - Original Text', function () {
	...
	beforeEach(function () {
       ...
       /*browser.ignoreSynchronization = true;
        ...
        legisDocDisplayPage.get(testData.legislation.sections.load_text.marginal_id_already_original_text);
	...
	it('should verify original text that is already present', function () {
        
        section.clickOnOriginalTextTab.then(function(){
            expect(section.getColorOfOriginalText).toEqual('rgba(226, 130, 3, 1)');
            expect(section.isDisplayedImportPDFButton).toBeTruthy();
            expect(section.isDisplayedLoadXmlButton).toBeTruthy();
            expect(section.isDisplayedOriginalTextPdfDiv).toBeTruthy();
