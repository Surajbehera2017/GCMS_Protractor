...
describe('Legislation Document Display - Right Panel - Document Structure', function () {
	...
	beforeEach(function () {
        ...
        legisDocDisplayPage.get(testData.legislation.sections.load_text.marginal_id_delete_in_force_structure);
var loginpopup =  element(by.model('credentials.username'));
	...
	it('should verify deleting in force structure', function () {
        legisDocDisplayPage = new LegislationDocumentDisplayPage();
            ...
            section.clickOnDocumentStructureTab.then(function(){
                section.clickFirstUnitRow.then(function(){
                    section.clickOnStructureActions.then(function(){
                        section.clickOnDeleteDocumentStructure.then(function(){
                           section.clickOnYesPopupConfirmationDeleteDocumentStructure.then(function(){
