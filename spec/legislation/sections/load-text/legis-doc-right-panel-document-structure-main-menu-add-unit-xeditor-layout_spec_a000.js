...
describe('Legislation Document Display - Load Text section', function () {
	...
	it('should verify the layout of add unit xeditor', function () {
        
        section.clickOnDocumentStructureTab.then(function(){
            section.clickOnStructureActions.then(function(){
                section.clickOnAddNewUnitFromEditor.then(function(){
                    expect(section.isSaveOnXEditorDisplayed).toBeTruthy();
                    expect(section.isCancelOnXEditorDisplayed).toBeTruthy();
                    expect(section.isDocumentTextOnXEditorDisplayed).toBeTruthy();
                    expect(section.isInternalNoteOnXEditorDisplayed).toBeTruthy();
                });
            });
        });
