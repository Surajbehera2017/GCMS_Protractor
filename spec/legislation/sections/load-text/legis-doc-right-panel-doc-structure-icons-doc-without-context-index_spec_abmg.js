...
describe('Legislation Document Display - Right Panel - Document Structure - icons', function () {
	...
	beforeEach(function () {
       ...
       /*browser.ignoreSynchronization = true;
        ...
        legisDocDisplayPage.get(testData.legislation.sections.load_text.marginal_id_without_context_index);
	...
	it('should verify the document without context index', function () {
        legisDocDisplayPage = new LegislationDocumentDisplayPage();
