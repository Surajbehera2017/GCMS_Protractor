...
describe('Bill Section', function () {
    ...
    it('should verify add document bill section ceartion with information', function () {
		
	    browser.waitForAngular();
        billSection.clickAddButtonBill();
      ...
      /*  billSection.changelegislativeBody(testData.legislation.sections.bills.legislativeBodyText);
        billSection.changeStatueType(testData.legislation.sections.bills.change_statute_value); 
        billSection.clickprovisonDateButton();
        billSection.legismainKeyword(testData.legislation.sections.bills.mainKeyword);
        */                  
        });
