...
describe('Corrigendas', function () {
	...
	//Method: TC05 - Corrigenda Edit button in table -Edit Analyst - Analysis Date
	it('Edit button in table -Edit Analyst - Analysis Date',function(){
		...
		corrigendas.clickonAnalysyList();

		browser.getAllWindowHandles().then(function(handles) {
			var newTabHandle = handles[1];
			browser.switchTo().window(newTabHandle).then(function () {
				corrigendas.SelectAnalyst();
			});
			browser.switchTo().window(handles[0]);
			corrigendas.enterDateAnalyst(loadedData.analysis_date);
