...
describe('Corrigendas', function () {
	...
	it('Delete the record after click on Delete - Yes button - Cancel',function(){
        //Unable to add new record- hence not deleting. todo
		browser.waitForAngular();
		corrigendas.clickViewAllLink();
        browser.waitForAngular();
        corrigendas.clickSelectedItem();
        expect(corrigendas.isDeleteButtonEnable()).toEqual(true);
        corrigendas.clickDelete();
        browser.sleep(3000);
        expect(corrigendas.displayOfYesDelete()).toEqual(true); 
