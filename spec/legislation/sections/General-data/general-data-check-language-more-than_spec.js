...
describe('General-data', function () {
  ...
  it('it should check for multiple languages.'+jiraNum, function () {
        ...
        //checking more than one languages
        if(params.BU == 'gulf'){

            var elementpresent1=globalpo.isElementDisplayed(loaded.English);
     ...
     expect(elementpresent1).toEqual(true);
        ...
        var elementpresent1=globalpo.isElementDisplayed(loaded.Arabic);
        expect(elementpresent1).toEqual(true);
                          
            } else{
        
        var elementpresent1=globalpo.isElementDisplayed(loaded.Gallego);
        expect(elementpresent1).toEqual(true);

            }
        
        // var elementpresent1=globalpo.isElementDisplayed(loaded.Inglés);
        // expect(elementpresent1).toEqual(true);
        
        // var elementpresent1=globalpo.isElementDisplayed(loaded.Chino);
        // expect(elementpresent1).toEqual(true);
