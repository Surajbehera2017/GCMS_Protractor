...
var jiraNumber = 'GCMSQABANG-2469';
...
describe('Practice Area', function () {
	...
	it('should expand the practice area and then edit it.' + jiraNumber , function () {
		browser.waitForAngular();
		...
		rightpanelpage.expandSectionInLeftPanel(loaded.section);
		browser.sleep(2000);
		PracticeAreaDocEdition.selectPracticeAreaAnalystDropdown(loaded.name,loaded.analystname);
		browser.sleep(2000);
		rightpanelpage.clickOnbuttonInEditMode(loaded.save);
		browser.sleep(2000);
		globalfunction.clickOnElement(loaded.confirm);
		browser.sleep(2000);
		rightpanelpage.expandSectionInLeftPanel(loaded.section);
		browser.sleep(2000);
		var loc = globalfunction.isElementDisplayed(loaded.analyst);
		expect(loc).toEqual(true);
		
	});
	
	it('should expand the practice area and change the edited value.' + jiraNumber,function(){
		browser.waitForAngular();
		rightpanelpage.clickOnbuttonInEditMode(loaded.edit);
		browser.sleep(2000);
		rightpanelpage.expandSectionInLeftPanel(loaded.section);
		browser.sleep(2000);
		PracticeAreaDocEdition.selectPracticeAreaAnalystDropdown(loaded.text,loaded.value);
		browser.sleep(2000);
		rightpanelpage.clickOnbuttonInEditMode(loaded.save);
		browser.sleep(2000);
		globalfunction.clickOnElement(loaded.confirm);
		...
		rightpanelpage.expandSectionInLeftPanel(loaded.section);
		browser.sleep(2000);
		var el = globalfunction.isElementDisplayed(loaded.element);
