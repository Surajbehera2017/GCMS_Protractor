...
var jiraNum='GCMSQABANG-2429';
var jiraNum1='GCMSQABANG-2430';
...
describe('Grants and Subsidies', function () {
	...
	//TC01 - Grants and Subsidies - Add new document section - Layout

	it('Add new document section - Layout.'+jiraNum+'.'+jiraNum1, function () {

        browser.sleep(2000);
        rightpanelpage.clickOnbuttonInEditMode(loaded.addbutton);
        browser.sleep(2000);
        collectiveAgreementSection.enterMarginalIdImport(loaded.code,loaded.leg);
        browser.sleep(1000);

        globalpo.clickOnButtonForGlobal(loaded.calculatebutton);
        browser.sleep(1000);
        collectiveAgreementSection.clickAddCopy(loaded.addbutton);
      ...
      browser.sleep(2000);
       ...
       collectiveAgreementSection.clickSaveExitEdit(loaded.exitaddbutton);
       browser.sleep(2000);
