...
var jiraNumber = 'GCMSQABANG-2822';
...
describe('topic-subtopic', function () {
    ...
    //done
    //03 - Topic subtopic - selection through the pages
    it('Topic subtopic - selection through the pages.'+jiraNumber, function () {
       ...
       // browser.waitForAngular();
        ...
        topicSubtopicSection.EnterValueinSearchTopiccode(loadedData.tcode1);
        topicSubtopicSection.EnterValueinSearchSubTopiccode(loadedData.scode1);
        topicSubtopicSection.addMultipleTopicSubtopic(1);
        browser.sleep(2000);
        topicSubtopicSection.EnterValueinSearchTopiccode(loadedData.tcode2);
        topicSubtopicSection.EnterValueinSearchSubTopiccode(loadedData.scode2);
        topicSubtopicSection.addMultipleTopicSubtopic(1);
        browser.sleep(2000);
