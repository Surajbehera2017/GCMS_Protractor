...
var jiraNumber = 'GCMSQABANG-2297';
...
describe('topic-subtopic', function () {
	...
	//done
	//03 Filter by Topic Code-with percentage
	it('Filter by Topic Code-with percentage.'+jiraNumber, function () {
		...
		global.isElementDisplayed(loadedData.Topic);
