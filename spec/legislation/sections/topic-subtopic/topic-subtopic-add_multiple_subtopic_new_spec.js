...
var jiraNumber = 'GCMSQABANG-2534';
...
describe('topic-subtopic', function () {
  ...
  //done
  //05 - Adding Subtopics to the same Topic
  it('Adding Subtopics to the same Topic.' + jiraNumber, function () {
    ...
    topicSubtopicSection.addMultipleTopicSubtopic(3);
    browser.sleep(4000);
