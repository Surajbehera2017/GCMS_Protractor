...
var jiraNumber = 'GCMSQABANG-2532';
...
describe('topic-subtopic', function () {
    ...
    //done
    //11 - Not possible to add only Topic
    it('Not possible to add only Topic.'+jiraNumber, function () {
        ...
        browser.sleep(4000);
        expect(topicSubtopicSection.checkaddbutton()).toEqual(false);
    });
});
