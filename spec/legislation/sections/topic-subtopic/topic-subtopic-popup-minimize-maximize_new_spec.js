...
var jiraNumber = 'GCMSQABANG-2936';
...
describe('topic-subtopic', function () {
  ...
  //done
  //01 - Modal Windows - Topic Subtopic - Minimize
  it('Modal Windows- Topic Subtopic - Minimize.'+jiraNumber, function () {
    ...
    topicSubtopicSection.clickminimize();
    topicSubtopicSection.clickOnMinimizeButtonAgain();
