...
var jiraNumber='GCMSQABANG-2597';
...
describe('Thesaurus',function(){//('Thesaurus-section-Pencil Delete', function () {
    ...
    //140149020
    //GCMSQABANG-2597: 03 - Delete a row associated to a document from a thesaurus type -there are more than one entry
  
    it('Delete a row associated to a document from a thesaurus type.'+jiraNumber,function () {
        ...
        browser.getAllWindowHandles().then(function (handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                browser.ignoreSynchronization = false;
                browser.sleep(2000);
                globalpo.clickOnButtonForGlobal('Add');
                browser.sleep(1000);
