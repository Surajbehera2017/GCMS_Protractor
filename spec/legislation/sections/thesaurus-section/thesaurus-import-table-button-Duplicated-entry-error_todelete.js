...
describe('Thesaurus',function(){//('Import from summarization button', function () {
    ...
    //08 - Import from table button - Duplicated entry - Error
     var jiraNumber='GCMSQABANG-2611';
    it('Duplicated entry - Error - 4126 '+jiraNumber.link(params.jiraURL+jiraNumber), function () {
