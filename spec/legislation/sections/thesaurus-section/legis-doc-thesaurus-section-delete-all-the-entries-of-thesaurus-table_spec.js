...
var jiraNumber = 'GCMSQABANG-3085';
...
describe('Thesaurus',function(){//('Thesaurus-section-activate delete button', function () {
   ...
   //GCMSQABANG-3085:09 - Delete all the entries of Thesaurus table
   //GCMSQABANG-3052:02 - Delete all the entries of Thesaurus table
   //BOTH TEST CASES ARE COVERED
    it('should delete all the records and check count reduce to zero under thesaurus section.'+jiraNumber,function(){
