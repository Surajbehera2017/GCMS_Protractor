...
var jiraNumber = 'GCMSQABANG-2339';
...
describe('Date In Force', function () {
    ...
    it('should verify the message after change in date in force as prior date.'+jiraNumber, function () {
        ...
        expect(global.isElementDisplayed("//div[contains(text(),'**La fecha de vigencia es anterior a la fecha de disposición')]")).toEqual(true);
