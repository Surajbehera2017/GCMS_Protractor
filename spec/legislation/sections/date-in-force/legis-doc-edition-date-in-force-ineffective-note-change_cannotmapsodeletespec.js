...
describe('Date In Force', function () {
    ...
    //cannot be linked to JIRA_id
    it('should verify the change in ineffective note', function () {
        ...
        LegislationDateInForceSectionEdition.changeAndVerifyEffectiveType();
        ...
        var legisDocEditionPage = new LegislationDocumentEditionPage();
        expect(legisDocEditionPage.title).toEqual(loadedData.title);
