...
var jiraNumber = 'GCMSQABANG-2834';
...
it('should verify the change in date in force.'+jiraNumber, function () {
      ...
      browser.waitForAngular();
        ...
        LegislationDateInForceSectionEdition.changeInDateInForceNew(loadedData.date_in_force);
        browser.sleep(3000);
        LegislationDateInForceSectionEdition.clickSaveBtn(loadedData.index);
         browser.waitForAngular();
        // browser.sleep(2000);
        LegislationDateInForceSectionEdition.clickSavePopup();
       
       //authorNotes.clickOnButtonForGlobal(loadedData.savebtn);
        
        browser.waitForAngular();
        LegislationDateInForceSectionEdition.expandSection();
        expect(LegislationDateInForceSectionEdition.isExpanded()).toEqual(true);  
        expect(LegislationDateInForceSectionEdition.getValueOfDateInForce()).toEqual(loadedData.date_in_force);
