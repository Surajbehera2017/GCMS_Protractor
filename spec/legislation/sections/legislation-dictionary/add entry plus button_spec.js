...
describe('Legislation Dictionary', function () {
    ...
    it('check plus icon is enabled or not after selecting item and unit value',function(){
		...
		element(by.css('[class="label legDicTermLabel"]')).isPresent();
	    expect(legislationdictionary.isPresentSelectedSectionAddPage()).toEqual(true);              
	});
});