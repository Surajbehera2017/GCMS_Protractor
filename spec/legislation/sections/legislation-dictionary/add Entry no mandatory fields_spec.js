...
describe('Legislation Dictionary', function () {
    ...
    it('should add entry with no mandatory field',function(){
		...
		legislationdictionary.clearNmdnOnAddPage();
		legislationdictionary.clickPlusIconOnAddPage();
		legislationdictionary.clicksave();
		expect(legislationdictionary.getTextErrorOnSave()).toEqual(loadedData.legislation_dictionary.Error_Message);
	});
});