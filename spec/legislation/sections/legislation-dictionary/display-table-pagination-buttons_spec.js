...
describe('Legislation Dictionary', function () {
   	...
   	it('should click on the view all link once the section is expanded and check for pagination buttons are working or not',function(){

				legislationdictionary.clickViewAllLink();
      	browser.waitForAngular();
				expect(legislationdictionary.displayViewAllLink()).toEqual(true);
				
			  legislationdictionary.clickNextPagination();
				expect(legislationdictionary.isDisplayNextPagination()).toEqual(true);
				
			  legislationdictionary.clickPrevoiusPagination();
				expect(legislationdictionary.isDisplayPrevoiusPagination()).toEqual(true);
				
			  legislationdictionary.clickLastPagination();
				expect(legislationdictionary.isDisplayLastPagination()).toEqual(true);
				
			  legislationdictionary.clickFirstPagination();
			  expect(legislationdictionary.isDisplayFirstPagination()).toEqual(true);
		});		     
});