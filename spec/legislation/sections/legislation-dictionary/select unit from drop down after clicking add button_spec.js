...
describe('Legislation Dictionary', function () {
    ...
    it('select unit from drop down after clicking add button',function(){

		legislationdictionary.clickAddOnSection();
   	    expect(legislationdictionary.isDisplayAddOnSection()).toEqual(true);
		legislationdictionary.clickSearchOnAddPage();
		legislationdictionary.clickSelectSearchValueOnAddPage();
		browser.waitForAngular();
	});
});    
