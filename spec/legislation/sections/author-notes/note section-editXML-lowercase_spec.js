...
var jiraNumber1='GCMSQABANG-2766';
...
describe('Author Notes', function () {
    ...
    //TC40 -Add 1.0 Editor - Aranzadi - To non capital letters button
    it('author Note XML Editor and select lowercase.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                var subindex=rightpanelpage.isfontFormatOptionpresent(loaded.lowercase);
                ...
                expect(actualXMLText).toEqual(loaded.text_xml);
