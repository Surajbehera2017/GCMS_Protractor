...
var jiraNumber = 'GCMSQABANG-2762';
...
describe('Author Notes', function () {
    ...
    var jiraNumber1 = 'GCMSQABANG-2762';
    it('author Note XML-Italic button .'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.sleep(1000);
            authorNotes.fontFormatOptionsOnXMLeditor(loaded.overlineoption);
            browser.sleep(1000);
            //Verify the new xml
            var text_xml='<en-origen decoracion-texto="superrayado"></en-origen><texto><parrafo>$position</parrafo></texto>';
