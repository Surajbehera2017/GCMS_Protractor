...
var jiraNumber1='GCMSQABANG-2765';
...
describe('Author Notes', function () {
    ...
    //TC39 -Add 1.0 Editor - Aranzadi - To capital letters button
    it('author Note XML Editor and select uppercase.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                var subindex=rightpanelpage.isfontFormatOptionpresent(loaded.uppercase);
                expect(subindex).toEqual(true);
                
                rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.uppercase);
                //verify the xml
                var text_xml='<en-origen transformacion-texto="mayusculas"></en-origen><texto><parrafo>$position</parrafo></texto>';
