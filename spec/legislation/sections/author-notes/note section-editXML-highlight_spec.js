...
// test data support for various BU's
var jiraNumber = 'GCMSQABANG-3543';
...
describe('Author Notes', function () {
    ...
    //TC12 -Add 1.0 Editor - Aranzadi - Destacado
    it('author Note XML Elementor Selector Dropdown and select Highlight', function () {
        ...
        browser.getAllWindowHandles().then(function (Handle1) {
            ...
            browser.switchTo().window(Handle1[1]).then(function () {
                ...
                browser.sleep(3000);
                rightpanelpage.dropDownOptionsOnXMLeditor("Highlight");
                browser.sleep(2000);
                global.isElementDisplayed("//span[text()='destaca.aranzadi']");
            })
