...
describe('Author Notes', function () {
    ...
    //Method: TC01 - Author Notes - Select Section and Section ID - Add - Layout
     it('and Section ID - Add - Layout', function () {
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                authorNotes.clickonVersioninUnitLevel();
                authorNotes.clickonoptioninVersionofUnitLevel();
                    
                //authorNotes.clickonUnitLevelDropdown();
                //browser.waitForAngular();
                //authorNotes.clickonOptionInUnitLevelDropdown();
