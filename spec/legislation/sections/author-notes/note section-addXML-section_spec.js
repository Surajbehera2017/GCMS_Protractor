...
var jiraNumber1='GCMSQABANG-3297';
...
describe('Author Notes', function () {
    ...
    //TC05 -Add 1.0 Editor - Aranzadi - Section
    it('author Note XML Elementor Selector Dropdown and select Section.'+jiraNumber1, function () { 
       
        globalpage.clickOnSectionButton(loaded.section_name,loaded.linktolink);
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                rightpanelpage.dropDownOptionsOnXMLeditor(loaded.section);
                
                //verify the xml
                var text_xml='<paragraph></paragraph><texto><parrafo>$position</parrafo></texto>';
