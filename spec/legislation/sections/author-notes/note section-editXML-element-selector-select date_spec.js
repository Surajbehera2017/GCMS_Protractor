...
var jiraNumber = 'GCMSQABANG-2734';
...
describe('Author Notes', function () {
    ...
    //TC07 -Add 1.0 Editor - Aranzadi - Fecha
    it('author Note XML - Elementor Selector Dropdown and select Date.'+jiraNumber, function () {  
        ...
        browser.getAllWindowHandles().then(function (Handle1) {
            ...
            browser.switchTo().window(Handle1[1]).then(function () {
                ...
                browser.sleep(3000);
                global.clickOnSelectXmlEditorSelectDateAndPerform("testing","13-6-2018");
                browser.sleep(3000);
                global.isElementDisplayed("//span[text()='valor']");
            })
