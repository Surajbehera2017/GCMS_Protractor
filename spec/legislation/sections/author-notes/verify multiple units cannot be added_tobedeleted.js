...
describe('Author Notes', function () {
    ...
    //Method: TC01 - Author Notes - Select Section and Section ID - Add - Layout
     it('verify multiple units cannot be added', function () {
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                authorNotes.clickUnitValue(3);
                browser.sleep(5000);
                authorNotes.clickUnitButton();
                
                expect(authorNotes.getAddedUnitValue()).toContain(authorNotes.getUnitValue(3));
