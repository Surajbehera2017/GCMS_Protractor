...
var jiraNumber1='GCMSQABANG-2737';
...
describe('Author Notes', function () {
    ...
    //TC12 -Add 1.0 Editor - Aranzadi - Derogado
    it('author Note XML Elementor Selector Dropdown and select Repeal.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                //verify the xml
                var text_xml='<derogado></derogado><texto><parrafo>$position</parrafo></texto>';
