...
var jiraNumber1='GCMSQABANG-3205';
...
describe('Author Notes', function () {
    ...
    // 03 - Author note table from By Context Index
    it('to verify delete button disabled.'+jiraNumber1, function () {

        authorNotes.expandSectionInLeftPanel(loaded.section);
        globalpage.clickOnSectionButton(loaded.section,loaded.linktolink);
		browser.sleep(5000);
		var isDelbuttondisabled = globalpage.clickOnbuttonInsideSectionTable('Delete');
		browser.sleep(1000);
        expect(isDelbuttondisabled).toEqual(true);
