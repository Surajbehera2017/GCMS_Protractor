...
var jiraNumber1='GCMSQABANG-2626';
var jiraNumber2='GCMSQABANG-3229';
...
describe('Author Notes', function () {
    ...
    //04 - Author note table from  By Type of Note
    //06 - Author note table from  a Type of note
    it('by Type of Note.'+jiraNumber1+'.'+jiraNumber2, function () {

        authorNotes.expandSectionInLeftPanel(loaded.section);
        globalpage.clickOnSectionButton(loaded.section,loaded.link);
        browser.sleep(3000);
