...
var jiraNumber = 'GCMSQABANG-2763';
...
describe('Author Notes', function () {
    ...
    var jiraNumber1 = 'GCMSQABANG-2763';
    it('author Note XML-Italic button .'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.sleep(1000);
            authorNotes.fontFormatOptionsOnXMLeditor(loaded.strikeoption);
            browser.sleep(1000);
            //Verify the new xml
            var text_xml='<en-origen decoracion-texto="tachado"></en-origen><texto><parrafo>$position</parrafo></texto>';
