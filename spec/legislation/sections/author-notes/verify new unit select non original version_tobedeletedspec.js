...
describe('Author Notes', function () {
    ...
    it('verify new unit select non original version then cancel', function () {
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                browser.sleep(5000);
                authorNotes.selectVersionDropdownOption('1');

                authorNotes.clickUnitLevelDropdownOption();
                browser.sleep(5000);
                authorNotes.selectUnitLevelDropdownOption('1');
