...
var jiraNumber1='GCMSQABANG-2738';
...
describe('Author Notes', function () {
    ...
    //TC11 -Add 1.0 Editor - Aranzadi - Inconstitucional
    it('author Note XML Elementor Selector Dropdown and select Inconstitucional.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                rightpanelpage.dropDownOptionsOnXMLeditor(loaded.unconstitutional);
                
                //Verify the new tags '<recomendaciones><recomendacion>' is displayed in the xml content
                var text_xml='<inconstitucional></inconstitucional><texto><parrafo>$position</parrafo></texto>';
