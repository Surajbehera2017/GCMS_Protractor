...
var jiraNumber1='GCMSQABANG-2755';
...
describe('Author Notes', function () {
    ...
    //TC29 -Add 1.0 Editor - Aranzadi - Subscript button
    it('author Note XML Editor and select Subscript.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                var subindex=rightpanelpage.isfontFormatOptionpresent(loaded.subscript);
                expect(subindex).toEqual(true);
                
                rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.subscript);
                //verify the xml
                var text_xml='<subindice></subindice><texto><parrafo>$position</parrafo></texto>';
