...
var jiraNumber1='GCMSQABANG-2747';
...
describe('Author Notes', function () {
    ...
    //TC20 -Add 1.0 Editor - Aranzadi - Imagen
    it('author Note XML Elementor Selector Dropdown and select Imagen.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                //verify the xml
                var text_xml='<figura ref="id">text</figura><texto><parrafo>$position</parrafo></texto>';
