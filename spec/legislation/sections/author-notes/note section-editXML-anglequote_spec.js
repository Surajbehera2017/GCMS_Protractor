...
var jiraNumber = 'GCMSQABANG-2757';
...
describe('Author Notes', function () {
    ...
    //Method: TC31 -Add 1.0 Editor - Aranzadi - Quotes button
    it('author Note XML select angle quote.'+jiraNumber, function () {
        browser.sleep(2000);
        ...
        browser.getAllWindowHandles().then(function (Handle1) {
            ...
            browser.switchTo().window(Handle1[1]).then(function () {
                ...
                authorNotes.fontFormatOptionsOnXMLeditor("Angle-Quote");
