...
var jiraNumber1='GCMSQABANG-2756';
...
describe('Author Notes', function () {
    ...
    //TC30 -Add 1.0 Editor - Aranzadi - Superscript button
    it('author Note XML Editor and select Superscript.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                var subindex=rightpanelpage.isfontFormatOptionpresent(loaded.superscript);
                expect(subindex).toEqual(true);
                
                rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.superscript);
                
                //verify the xml
                var text_xml='<superindice></superindice><texto><parrafo>$position</parrafo></texto>';
