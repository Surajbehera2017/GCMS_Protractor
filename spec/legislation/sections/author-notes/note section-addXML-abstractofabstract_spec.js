...
var jiraNumber1='GCMSQABANG-2745';
...
describe('Author Notes', function () {
    ...
    //TC18 -Add 1.0 Editor - Aranzadi - Resumen de Resumen
    it('author Note XML Elementor Selector Dropdown and select Abstarct of abstarct.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                rightpanelpage.dropDownOptionsOnXMLeditor(loaded.abstract);
                
                //verify the xml
                var text_xml='<abstract.summary></abstract.summary><texto><parrafo>$position</parrafo></texto>';
