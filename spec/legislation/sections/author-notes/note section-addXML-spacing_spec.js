...
var jiraNumber1='GCMSQABANG-3840';
...
describe('Author Notes', function () {
    ...
    //TC01- Add 1.0 Editor - Aranzadi - Espaciado
    it('author Note XML Elementor Selector Dropdown and select spacing.'+jiraNumber1, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.switchTo().window(newTabHandle).then(function () {
                ...
                rightpanelpage.dropDownOptionsOnXMLeditor(loaded.spacing);
                
                //verify the xml
                var text_xml='<parrafo espaciado-anterior="simple"></parrafo><texto><parrafo>$position</parrafo></texto>';
