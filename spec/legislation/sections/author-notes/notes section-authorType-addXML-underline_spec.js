...
var jiraNumber = 'GCMSQABANG-2761';
...
describe('Author Notes', function () {
    ...
    it('author Note XML-Italic button .'+jiraNumber, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.sleep(1000);
            authorNotes.fontFormatOptionsOnXMLeditor(loaded.underlineoption);
            browser.sleep(1000);
            //Verify the new xml
            var text_xml='<en-origen decoracion-texto="subrayado"></en-origen><texto><parrafo>$position</parrafo></texto>';
