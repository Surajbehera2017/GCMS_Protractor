...
var jiraNumber = 'GCMSQABANG-2759';
...
describe('Author Notes', function () {
    ...
    //TC33 -Add 1.0 Editor - Aranzadi - Italic button
    it('author Note XML-Italic button .'+jiraNumber, function () { 
        ...
        browser.getAllWindowHandles().then(function(handles) {
            ...
            browser.sleep(1000);
            authorNotes.fontFormatOptionsOnXMLeditor('Italic');
            browser.sleep(1000);
            //Verify the new xml
            var text_xml='<en-origen estilo-fuente="cursiva"></en-origen><texto><parrafo>$position</parrafo></texto>';
