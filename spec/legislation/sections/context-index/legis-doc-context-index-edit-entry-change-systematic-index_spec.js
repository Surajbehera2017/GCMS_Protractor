...
//i18n basic support
 ...
 var jiraNumber= 'GCMSQABANG-2691'; 
...
describe('Context Index', function () {
    ...
    //04 - Edit entry - change systematic Index
  
  it('edit all values of the existing context index.' +jiraNumber, function () {
        ...
        browser.sleep(1000);
          ...
          browser.getAllWindowHandles().then(function(handles) {
           ...
           browser.switchTo().window(newTabHandle).then(function () {
                ...
                browser.sleep(1000);
                contextindexpage.selectCodexSystematicIndexFromDropdown(loaded.expectedvalue1);
                browser.sleep(1000);
