...
//i18n basic support
 ...
 var jiraNumber1= 'GCMSQABANG-3556';
 var jiraNumber2= 'GCMSQABANG-3553';
...
describe('Context Index', function () {
    ...
    //10 - Modal - Context index edit
    
  it('Modal - Context index edit - Minimize window.' +jiraNumber1, function () {
        ...
        browser.sleep(3000);
        contextindexpage.contextindexAction(loaded.edit_icon);
        browser.sleep(2000);
       ...
       //11 - Modal - Context index edit
     it('Modal - Context index edit - close window.' +jiraNumber2, function () {
