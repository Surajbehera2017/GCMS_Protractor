...
//i18n basic support
 ...
 var jiraNumber= 'GCMSQABANG-2797'; 
  ...
  it('Add - Save both fields with no original version.' +jiraNumber, function () {
      ...
      browser.getAllWindowHandles().then(function(handles) {
        ...
        browser.switchTo().window(newTabHandle).then(function () {
          ...
          browser.sleep(2000);
          authorNotes.selectAndAddUnitFromDropDown('A.267','level');
          var a=['version','level','unit'];
          var b=[loaded.version,'Nivel nuevo','PR.1'];
        ...
        browser.sleep(1000);
        contextindexpage.enterValueInSearchField('term','Índice de conceptos');
        browser.sleep(1000);
        contextindexpage.enterValueInSearchField('unit','1#A.267');
        browser.sleep(1000);
