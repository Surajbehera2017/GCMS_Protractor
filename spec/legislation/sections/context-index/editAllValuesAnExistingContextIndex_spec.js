...
//i18n basic support
 ...
 var jiraNumber= 'GCMSQABANG-2693'; 
...
describe('Context Index', function () {
  ...
  it('edit all values of the existing context index.' +jiraNumber, function () {
        ...
        browser.sleep(1000);
        contextindexpage.enterValueInSearchField('type','CODEX');
        browser.sleep(1000);
        ...
        browser.sleep(1000);
          ...
          browser.getAllWindowHandles().then(function(handles) {
           ...
           browser.switchTo().window(newTabHandle).then(function () {
                ...
                browser.sleep(5000);
                contextindexpage.selectCodexSystematicIndexFromDropdown('Body');
                browser.sleep(2000);
