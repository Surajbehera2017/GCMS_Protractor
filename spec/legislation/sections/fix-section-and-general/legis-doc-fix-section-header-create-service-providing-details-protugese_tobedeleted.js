...
describe('Fix section', function () {
    ...
    it('it should show the header for portugal',function(){
      
      
        LegislationSearchPage.ClickUserDropDown();
        browser.sleep(1000);
        LegislationSearchPage.selectPortugues();     
        expect(LegislationSearchPage.isExpectedDetailsDisplayed("Bem-vindo")).toEqual(true);
    });
