...
var jiraNumber = 'GCMSQABANG-3269';
...
describe('Document Creation', function () {
	...
	it('verify error message if provision date is not provided for Actos Prepatorious.GCMSQABANG-3269', function () {
		...
		//Enter all mandatory fields except 'provision date'
		...
		//Enter mandatory fields - statute data. Dont enter provision date
		...
		//click create & verify provision date error message
		page.clickCreate();
