...
var jiraNumber='GCMSQABANG-3274';
...
describe('Document Creation', function () {
	...
	it('verify error message if legislative body is not selected for Actos Prepatorious.GCMSQABANG-3274.'+jiraNumber, function () {
		...
		expect(firstError).toEqual('The field legislation authority is mandatory');
