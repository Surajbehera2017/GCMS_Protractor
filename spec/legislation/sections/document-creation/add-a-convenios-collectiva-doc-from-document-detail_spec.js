...
var jiraNumber='GCMSQABANG-3267';
...
var collectiveAgreementsSection = require('../../../../po/document/edition/legis/sections/collective-agreement/collective-agreement.po');
...
describe('Document Creation', function () {
	...
	it('Add a doc from document detail - Convenio Colectivo.GCMSQABANG-3267', function () {
		...
		//collectiveAgreementsSection.collapseSection();

		//click create
		page.clickCreate();
		browser.waitForAngular();
		page.isOkButtonDisplayed().then(function(result){
			if(result === true){
				//Data issue - warning.
				page.clickonOk();
				browser.waitForAngular();
