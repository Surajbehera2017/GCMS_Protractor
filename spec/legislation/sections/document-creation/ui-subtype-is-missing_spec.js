...
describe('Document Creation', function () {
	...
	it('verify error message if document type is not provided', function () {
		...
		//Enter all mandatory fields except 'document type'
		...
		//Select jusrisdiction. Dont select document type
		generalDataSection.jurisdictionSelect();
		generalDataSection.jurisdictionSelectOption('Barcelona');
		...
		statuteDataSection.selectFirstLegislativeBody('Ayuntamiento de Barcelona');

		//click create & verify document type error message
		page.clickCreate();
		var firstError = page.getFirstSaveErrorMessage();
		expect(firstError).toEqual('The field document type is mandatory');
