...
var jiraNumber='GCMSQABANG-3280';
...
describe('Document Creation', function () {
	...
	it('verify add button with text functionality.GCMSQABANG-3280.'+jiraNumber, function () {
		...
		var expMarginal = loadedData.code + loadedData.year_1 + '\\' + loadedData.numberToEnter_1+' '+loadedData.text;
		expect(documentDisplayPage.getMarginalNumber()).toEqual(expMarginal);
	});
