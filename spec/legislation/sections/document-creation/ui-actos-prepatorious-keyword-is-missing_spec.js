...
var jiraNumber='GCMSQABANG-3253';
...
describe('Document Creation', function () {
	...
	it('verify error message if keyword is not provided for Actos prepatorius.GCMSQABANG-3253.'+jiraNumber, function () {
		...
		//Enter all mandatory fields except 'keyword'
		...
		//Select 'Actos prepatorius' as document type
		...
		//click create & verify keyword error message
		page.clickCreate();
		var firstError = page.getFirstSaveErrorMessage();
		expect(firstError).toEqual('The field keyword is mandatory');
