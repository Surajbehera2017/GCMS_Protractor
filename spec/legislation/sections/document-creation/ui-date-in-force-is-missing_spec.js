...
var jiraNumber = 'GCMSQABANG-3238';
...
describe('Document Creation', function () {
	...
	it('verify error message if DateInForce is not provided for Legislation.GCMSQABANG-3238', function () {
		...
		//Enter all mandatory fields except 'date inforce'
