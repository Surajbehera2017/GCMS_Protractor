...
var jiraNumber = 'GCMSQABANG-3256';
...
describe('Document Creation', function () {
	...
	it('verify error message if Practice Area is not provided for Actos Prepatorious.GCMSQABANG-3256', function () {
		...
		page.clickCreate();
		if(params.BU=="br"){
			var firstError = page.get2ndSaveErrorMessage();
		}
		else{
