...
var jiraNumber = 'GCMSQABANG-3241';
...
describe('Document Creation', function () {
	...
	it('verify error message if Practice Area is not provided for Legislation.GCMSQABANG-3241', function () {
		...
		//Enter all mandatory fields except 'practice area'
        ...
        dateInForceSection.changeInDateInForceNew(loadedData.date_in_force);
        dateInForceSection.collapseSection();
        browser.waitForAngular();

        //click create & verify practice area error message
		page.clickCreate();
