...
var jiraNumber = 'GCMSQABANG-3234';
...
describe('Document Creation', function () {
	...
	it('verify error message if publication is not provided for Convenio Colectivo.GCMSQABANG-3234', function () {
		...
		//Enter all mandatory fields except 'publication'
		...
		generalDataSection.selectDocumentTypeFromComboBox(loadedData.document_type1);
		...
		//Do not Enter mandatory fields - publication data
		publicationDataSection.expandableEdit.expand();
		browser.waitForAngular();

		//click create & verify publication error message
		page.clickCreate();
