...
describe("Collective Agreements", function () {
	...
	it('Add a doc with the collective agreements section.'+jiraNum+'.'+jiraNum1, function () {
        ...
        browser.sleep(1000);
        collectiveAgreementSection.enterMarginalIdImport('Year','1947');
        ...
        browser.sleep(1000);
        globalpo.selectValueDropdown(loaded.sectionname,loaded.conventype);
        browser.sleep(4000);
        ...
        //strong[contains(text(),'Collective Agreements')]
        // globalpo.expandSectionInLeftPanel(loaded.modulename1);
         browser.sleep(1000);
