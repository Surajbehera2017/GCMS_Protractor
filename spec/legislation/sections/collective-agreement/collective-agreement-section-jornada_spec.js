...
describe("Collective Agreements", function () {
    ...
    it('should able to add value in jornada feild.'+jiraNum, function () {
        ...
        collectiveAgreementSection.enterTextinFeilds(loaded.feildname,loaded.jornadavalue);
         browser.sleep(2000);
