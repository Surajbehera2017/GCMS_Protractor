...
var jiraNumber='GCMSQABANG-1819';
...
describe('Document-structure', function () {
  ...
  afterEach(function () {//Close additional tab
    ...
    /* GCMSQABANG-1819 24- Borrar numparagraph with unidad as a child */
       
	it('Borrar numparagraph with unidad as a child.'+jiraNumber, function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_12);
        browser.sleep(1000);
