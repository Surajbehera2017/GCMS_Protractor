...
var jiraNumber='GCMSQABANG-1815';
...
describe('Document-structure', function () {
  ...
  afterEach(function () {//Close additional tab
	...
	/*
	 *  GCMSQABANG-1815 20- Borrar numparagraph with orderedlist as a child
	 */
        
	it(' Borrar numparagraph with orderedlist as a child.'+jiraNumber,function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_9);
        browser.sleep(1000);
