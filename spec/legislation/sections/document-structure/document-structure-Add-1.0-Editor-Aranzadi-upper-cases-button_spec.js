...
var jiraNumber='GCMSQABANG-1721';
...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1721 TC41 -Add 1.0 Editor - Aranzadi - To capital letters button
	 */
    
    it('Add Editor Aranzadi upper case button.'+jiraNumber, function () {
		...
		var buttonValidated = rightpanelpage.isfontFormatOptionpresent(loaded.uppercase);
		...
		//var expectedXmlAfterReplacement = '<en-origen transformacion-texto="mayusculas"><nota ref="test" o=""/></en-origen>note<abstract.summary></abstract.summary>';
		...
		rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.uppercase);
