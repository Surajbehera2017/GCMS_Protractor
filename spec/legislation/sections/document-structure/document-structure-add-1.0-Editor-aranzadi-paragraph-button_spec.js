...
var jiraNumber='GCMSQABANG-1702';
...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1702 TC40 -Add 1.0 Editor - Aranzadi - Paragraph button
	 */
    
    it('Add Editor Aranzadi Paragraph button.'+jiraNumber,function () {
		...
		var buttonValidated = rightpanelpage.isfontFormatOptionpresent(loaded.paragraph);
		...
		var expectedXmlAfterReplacement = '<parrafo><nota ref="test" o=""/></parrafo>note<abstract.summary></abstract.summary>';
		...
		rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.paragraph);
