...
var jiraNumber='GCMSQABANG-1809';
...
describe('Document-structure', function () {
	...
	/*
	 *  GCMSQABANG-1809 14- Borrar numparagraph with falta.table as a child
	 */
        
      it('Borrar numparagraph with falta.table as a child.'+jiraNumber, function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_5);
        browser.sleep(1000);
