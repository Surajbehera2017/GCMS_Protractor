...
describe('Document-structure', function () {
    ...
    afterEach(function () {//Close additional tab
	 ...
	 // GCMSQABANG-1800: 07- Delete Notatexthist Element with table
    jiraNumber='GCMSQABANG-1800'
	it('Delete Notatexthist Element with table.'+jiraNumber, function () {
        ...
        browser.sleep(1000);
        rightpanelpage.clickOnTabInsideVisualEditor(loaded.table_tab);
        browser.sleep(4000);
        rightpanelpage.clickOnFirstoptionofTable('1062');
        browser.sleep(4000); 
        rightpanelpage.clickOnAddorCancelinTable('Add');
        browser.sleep(1000);       
