...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1704 TC20 -Add 1.0 Editor - Aranzadi - Resumen de Resumen
	 */
	it('Unit Xeditor Element Selector Abstract of Abstract Resumen de Resumen.'+jiraNum, function () {
		...
		//Select Abstract of Abstract(Resumen de Resumen) from Element selector drop down
		//var expOpton = I18n.documentstructure.elementselectoroption.abstract;
		rightpanelpage.dropDownOptionsOnXMLeditor(loaded.abstractofabstract);
		
		//Verify the new tag '<abstract.summary>' is displayed
		var validateTagInXML = rightpanelpage.isXmlTagsArePresent(loaded.abstractsummaryTag);
