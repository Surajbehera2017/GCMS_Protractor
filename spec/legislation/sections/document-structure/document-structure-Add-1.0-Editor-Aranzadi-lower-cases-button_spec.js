...
var jiraNumber='GCMSQABANG-1722';
...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1722 TC42 -Add 1.0 Editor - Aranzadi - To non capital letters button
	 */
    
    it('Add  Editor Aranzadi Lower case button.'+jiraNumber,function () {
		...
		var buttonValidated = rightpanelpage.isfontFormatOptionpresent(loaded.lowercase);
		...
		//var expectedXmlAfterReplacement = '<en-origen transformacion-texto="minusculas"><nota ref="test" o=""/></en-origen>note<abstract.summary></abstract.summary>';
		...
		rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.lowercase);
