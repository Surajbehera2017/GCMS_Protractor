...
describe('Document-structure', function () {
    ...
    it('Right Panel Document Structure Unit Menu Add a Unit from Structure using XML Full document load Fails.'+jiraNumber, function () {
       ...
       // var errorContains=getError.includes(loadedData.contains_msg);
        expect(getError).toContain(loadedData.contains_msg);

      //  var errorContains= getError.includes(loadedData.contains_msg);
        //expect(getError).toEqual(loadedData.import_xml_error);
