...
var jiraNumber='GCMSQABANG-1719';
...
describe('Document-structure', function () {
    ...
    afterEach(function () {//Close additional tab
	 ...
	 /*
	 * GCMSQABANG-1719 TC39 -Add 1.0 Editor - Aranzadi - Strikethrough button
	 */
    
    it('Add Editor Aranzadi Strikethrough button.'+jiraNumber, function () {
		...
		var buttonValidated = rightpanelpage.isfontFormatOptionpresent(loaded.strikethrough);
		...
		//var expectedXmlAfterReplacement = '<en-origen decoracion-texto="tachado"><nota ref="test" o=""/></en-origen>note<abstract.summary></abstract.summary>';
		...
		rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.strikethrough);
