...
describe('Document-structure', function () {
  ...
  */
  ...
  it('Copy external text Paragraphs and styles Unit edition Verify XML code.'+jiraNumber+'.'+jiraNumber_1, function () {
    ...
    // rightpanelpage.clickOnOriginalLabel(15);
    // browser.waitForAngular();
    // rightpanelpage.clickOnEditVisualLabel(2);
    // browser.switchTo().frame('legistext');
    // browser.ignoreSynchronization = true;
    // browser.sleep(1000);
    // rightpanelpage.clickOnPasteDropdown();
    // rightpanelpage.selectOptionFromPasteDropdown(2);  // Select Paste External Text
    // rightpanelpage.enterTextIntoWordPopup(loaded.first_version_text);
    // rightpanelpage.clickonAnyAvailableButtonInEditVisual(46);
    // browser.switchTo().defaultContent();
    // browser.ignoreSynchronization = false;
    // rightpanelpage.clickOnsaveButton();
    // browser.actions().sendKeys(protractor.Key.ESCAPE).perform();
    // //  rightpanelpage.clickOkpopup();
