...
var jiraNumber='GCMSQABANG-3725';
...
describe('Document-structure', function () {
    ...
    afterEach(function () {//Close additional tab
	 ...
	 /* GCMSQABANG-3725 11- Eliminar numparagraph element with table as a child  */
        
    it('Eliminar numparagraph element with table as a child.'+jiraNumber,function () {
