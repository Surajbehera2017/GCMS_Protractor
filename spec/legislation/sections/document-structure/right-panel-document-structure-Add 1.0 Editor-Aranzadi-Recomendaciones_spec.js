...
describe('Document-structure', function () {
	...
	afterEach(function () {//Close additional tab
	 ...
	 // GCMSQABANG-1700 TC15 -Add 1.0 Editor - Aranzadi - Recomendaciones
	 
	it('Unit Xeditor Element Selector Recommendations Recomendaciones.'+jiraNum, function () {
		...
		//Select Recommendations from Element selector drop down
		var expOpton = I18n.documentstructure.elementselectoroption.recommendation;
		rightpanelpage.dropDownOptionsOnXMLeditor(loaded.recommendations);
		
		//Verify the new tags '<recomendaciones><recomendacion>' is displayed in the xml content
		var validateTagInXML = rightpanelpage.isXmlTagsArePresent(loaded.recomendacionesTag);
