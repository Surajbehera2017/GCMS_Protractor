...
var  jiraNumber='GCMSQABANG-1802';
...
afterEach(function () {//Close additional tab
  ...
  browser.switchTo().window(handles[0]);
	...
	/*
	 *  GCMSQABANG-1802 03- Eliminar numparagraph element with paragraph as a child
	 */
        
	it('Eliminar numparagraph element with paragraph as a child.'+jiraNumber, function () {
