...
var jiraNumber='GCMSQABANG-1803';
...
describe('Document-structure', function () {
  ...
  afterEach(function () {//Close additional tab
	...
	/*
	 * GCMSQABANG-1803 04- Borrar numparagraph with paragraph as a child
	 */
       
	it('Borrar numparagraph with paragraph as a child.'+jiraNumber, function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_10);
        browser.sleep(1000);
