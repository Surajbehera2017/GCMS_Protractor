...
var jiraNumber='GCMSQABANG-1811';
...
describe('Document-structure', function () {
  ...
  afterEach(function () {//Close additional tab
	...
	/*
	 * GCMSQABANG-1811 16- Borrar numparagraph with figura as a child
	 */
         
	it('Borrar numparagraph with figura as a child.'+jiraNumber, function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_6);
        browser.sleep(1000);
