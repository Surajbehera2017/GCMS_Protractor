...
var jiraNumber='GCMSQABANG-1716';
...
describe('Document-structure', function () {
	...
	/*GCMSQABANG-1716  TC36 -Add 1.0 Editor - Aranzadi - Bold + Italic button */
    
    it('Add  Editor Aranzadi Bold and italics button.'+jiraNumber, function () {
		...
		// var expectedXmlAfterReplacement = '<en-origen peso-fuente="negrita" estilo-fuente="cursiva"><nota ref="test" o=""/></en-origen>note<abstract.summary></abstract.summary>';
