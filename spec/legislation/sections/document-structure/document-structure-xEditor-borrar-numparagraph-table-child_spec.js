...
var jiraNumber='GCMSQABANG-1807';
...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1807 12- Borrar numparagraph with table as a child
	 */
    
	it('Borrar numparagraph with table as a child.'+jiraNumber, function () {
        ...
        browser.sleep(2000);
        rightpanelpage.clickOnTabInsideVisualEditor(loaded.table);
        browser.sleep(1000);
        rightpanelpage.clickOnFirstoptionofTable(loaded.id_number);
        browser.sleep(1000);
        rightpanelpage.clickOnAddorCancelinTable(loaded.add); 
        browser.sleep(1000);
