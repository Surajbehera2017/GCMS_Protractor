...
//ALREADY AUTOMATED..NO NEED TO AUTOMATE
	...
	it('Add Unit Xeditor Unit Menu Added as Child', function () {
        ...
        rightpanelpage.rightClickonTextLorumandSelectFaltaFigura();
		var falta = rightpanelpage.isFaltaFiguraIconDisplayedAnother();
        expect(falta).toEqual(true);
        browser.waitForAngular();
        rightpanelpage.clickFaltaFiguraIconDisplayedAnother();
        ...
        browser.waitForAngular();
        rightpanelpage.writeFieldInInnerTitleEditPopUp(loadedData.falta_figura_data,16);
        rightpanelpage.writeFieldInInnerTitleEditPopUp(loadedData.falta_figura_exe,17);
        
     //   rightpanelpage.clickInserttButtonFaltaFiguraDialogBox();
