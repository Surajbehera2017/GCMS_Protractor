...
var jiraNumber='GCMSQABANG-1717';
...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1717 TC37 -Add 1.0 Editor - Aranzadi - Underline button 
	 */
    
    it('Add Editor Aranzadi Underline button.'+jiraNumber, function () {
		...
		var buttonValidated = rightpanelpage.isfontFormatOptionpresent(loaded.underline);
       ...
       // var expectedXmlAfterReplacement = '<en-origen decoracion-texto="subrayado"><nota ref="test" o=""/></en-origen>note<abstract.summary></abstract.summary>';
		...
		rightpanelpage.fontFormatOptionsOnXMLeditor(loaded.underline);
