...
describe('Document-structure', function () {
     ...
     //GCMSQABANG-1840: 05- Unwrrapping-math element with mathsubindex
        //var jiraNum='GCMSQABANG-1840';
          it('Unwrapping the math sub section and save the parrafaro.'+jiraNum, function () {
            ...
            browser.sleep(1000);
            rightpanelpage.moveToInsertAndSelectElement(loaded.mathsub);// Always move the option into Insert element
            browser.sleep(1000);
            browser.sleep(1000);  
