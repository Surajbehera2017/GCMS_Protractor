...
var jiraNumber='GCMSQABANG-1805';
...
describe('Document-structure', function () {
	...
	/*
	 * GCMSQABANG-1805 06- Borrar numparagraph with nota.texto as a child
	 */
     
	it('Borrar numparagraph with nota texto as a child.'+jiraNumber,function () {
        ...
        browser.sleep(2000);
        rightpanelpage.fillMandotoryAttributeFields(loaded.field_name4,loaded.fieldTextName_4,'firsttext');
        rightpanelpage.fillMandotoryAttributeFields(loaded.field_name5,loaded.fieldTextName_5,'secondtext');
        rightpanelpage.fillMandotoryAttributeFields(loaded.field_name6,loaded.fieldTextName_6,'IdentiFactory');
        browser.sleep(2000); 
        ...
        browser.switchTo().frame(loaded.out_frame_id);
        browser.ignoreSynchronization = true;
        rightpanelpage.selectDataTypeAndPerform(loaded.elementname_3,loaded.element_delete);
        browser.sleep(1000);
        browser.switchTo().defaultContent();
