...
var jiraNumber='GCMSQABANG-3724';
...
describe('Document-structure', function () {
	...
	afterEach(function () {//Close additional tab
	 ...
	 /* GCMSQABANG-3724 09- Eliminar numparagraph element with repro as a child */
	   
    it('Eliminar numparagraph element with Repro as a child.'+jiraNumber,function () {
		...
		browser.sleep(1000);
		rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_13);
		browser.sleep(2000);
