...
var docFileToUpload = params.BU +'.GCMSQABANG-1606.xml';
var jiraNumber='GCMSQABANG-1606';
...
describe('Document-structure', function () {
    ...
    /*
	 *GCMSQABANG-1606:  TC04 - Right Panel - Document Structure - Unit Menu - Add a Unit from Structure using XML - Added as lower sibling
	 * 
	 */
    
    it('Right Panel Document Structure Unit Menu Add a Unit from Structure using XML Added as lower sibling.'+jiraNumber, function () {
