...
var jiraNumber='GCMSQABANG-1821';
...
describe('Document-structure', function () {
  ...
  afterEach(function () {//Close additional tab
	...
	/*
	 * GCMSQABANG-1821 02- Borrar numparagraph with parrafo as a child
	 */
       
	it('Borrar numparagraph with parrafo as a child.'+jiraNumber,function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_11);
        browser.sleep(1000);
