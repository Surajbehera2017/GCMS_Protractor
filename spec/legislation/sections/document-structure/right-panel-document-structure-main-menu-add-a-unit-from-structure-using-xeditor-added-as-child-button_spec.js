...
var jiraNumber= 'GCMSQABANG-1615';
...
describe('Document-structure', function () {
	 ...
	 */
	it('Add Unit Xeditor Unit Menu Added as Child.'+jiraNumber+'.'+jiraNumber_1, function () {
...
//browser.sleep(3000);
	...
	it('deletion of created unit'+ jiraNumber.link(params.jiraURL + jiraNumber) + jiraNumber_1.link(params.jiraURL + jiraNumber_1) , function () {
