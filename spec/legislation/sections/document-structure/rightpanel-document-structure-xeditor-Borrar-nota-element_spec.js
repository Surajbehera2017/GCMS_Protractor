...
var jiraNumber='GCMSQABANG-1793';
...
describe('Document-structure', function () {
    ...
    /* GCMSQABANG-1793  02- Borrar Nota element */
    
	it('Delete Nota element.'+jiraNumber,function () {
       ...
       //insert nota element
        ...
        browser.sleep(1000);
        rightpanelpage.fillMandatoryFieldsofNota(loaded.datatype,'ref*','ref123');
        rightpanelpage.fillMandatoryFieldsofNota(loaded.datatype,'o*','nota1');
        browser.sleep(2000); 
        browser.sleep(2000); 
        browser.switchTo().defaultContent();
        browser.ignoreSynchronization = false;
        ...
        browser.switchTo().frame(loaded.out_frame_id);
        browser.ignoreSynchronization = true;
        rightpanelpage.selectDataTypeAndPerform(loaded.elementname_14,loaded.element_delete);
        rightpanelpage.selectDataTypeAndPerform(loaded.elementname_8,loaded.element_delete);
        browser.sleep(1000);
        browser.switchTo().defaultContent();
