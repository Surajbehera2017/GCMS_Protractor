...
var jiraNumber='GCMSQABANG-1813';
...
describe('Document-structure', function () {
  ...
  afterEach(function () {//Close additional tab
	...
	/*
	 * GCMSQABANG-1813 18- Borrar numparagraph with falta.figura as a child
	 */
        
	it('Borrar numparagraph with falta figura as a child.'+jiraNumber, function () {
        ...
        browser.sleep(1000);
        rightpanelpage.moveToInsertAndSelectElement(loaded.elementname_4);
        browser.sleep(1000);
