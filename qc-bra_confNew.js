...
exports.config = {
	...
	//],
	 ...
	 baseUrl: 'https://client-gcms-br.int.thomsonreuters.com/',
	...
	suites: {
		 documentStructure: documentStructureFile.br.specs,
		// ControlData: controlDataFile.br.specs,
		// statuteData: statuteDataFile.br.specs,
		// Corrigendas: corrigendasFile.br.specs,
		//ContextIndex: contextIndexFile.br.specs,
		// authornotes: authorNotesFile.br.specs,
		// fixedsection: FixedSectionFile.br.specs,
		// labels: LabelsFiles.br.specs,
		// productworkbench: productWorkbenchFile.br.specs,
		// dateInForce: dateInForceFile.br.specs,
		// editorialnotes: editorialNotesFile.br.specs,
		// leftpanel: LeftPanelFile.br.specs,
		// rightpanel: RightPanelFile.br.specs,
		// legislativebody: legislativeBodyFile.br.specs,
		// publicationdata: PublicationDataFile.br.specs,
		// practicearea: practiceAreaFile.br.specs,
		// textVersion: textVersionFile.br.specs,
		//relationshipSearch: relationshipSearchFiles.br.specs,
		// generalData: generalDataFile.br.specs,
		// documentCreation: documentCreationFile.br.specs,
		//languagefilter: languageFilterFile.br.specs,
		// originalText: originalTextFile.br.specs,
		// thesaurus: thesaurusFile.br.specs,

		// /// -- Following modules are having more failures - not ready for daily run			
		//  relationshipSection: relationshipSectionFiles.br.specs,
