var LegislationBody = function() {  
    ...
    var _copyButton=element(by.xpath('//div[@id="panel-fixed-minified"]//*[@id="btnCopyfixSection"]'));
	...
	this.marginal=function() {
        //return element(by.css('[ng-bind="documentheader.documentation.data.document.marginal.numeroMarginal"]')).getText();
        return element(by.xpath('//div[@id="panel-fixed-minified"]//*[@ng-bind="documentheader.documentation.data.document.marginal.numeroMarginal"]')).getText();
    };

	this.range=function() {
      //  return element(by.css('[ng-bind="documentheader.documentation.data.document.rangos.list[0].rango.description"]')).getText();
      return element(by.xpath('//div[@id="panel-fixed-minified"]//*[@ng-bind="documentheader.documentation.data.document.rangos.list[0].rango.description"]')).getText();
    };
    
    this.docnum =function() {
        //  return  element(by.css('[ng-bind="documentheader.documentation.data.document.rangos.list[0].numeros.list[0].numdn"]')).getText();
            return  element(by.xpath('//div[@id="panel-fixed-minified"]//*[@ng-bind="documentheader.documentation.data.document.rangos.list[0].numeros.list[0].numdn"]')).getText();
    };
    
	this.lawarea=function() {
        return  element(by.xpath('//div[@id="panel-fixed-minified"]//*[@id="area-practice"]')).getText();
    };
    ...
    this.isCopyButtonDisplayed=function() {
        return  document.getElementById('\btnCopyfixSection\').style.visibility !== \'hidden\';','');
    };
    ...
    module.exports = new LegislationBody();