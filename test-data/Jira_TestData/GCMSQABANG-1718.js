var testData = {
    qc: {
        spain: {
            ...
            expectedXmlAfterReplacement : '<en-origen decoracion-texto="superrayado"><nota ref="test" o=""/></en-origen>note<abstract.summary></abstract.summary>',
         },
         br: {
