var testData = {
    qc: {
        spain: {
            ...
            expectedXmlAfterReplacement:'<parrafo><nota ref="test" o=""/></parrafo>note<abstract.summary></abstract.summary>',
        ...
        gulf:{
            ...
            expectedXmlAfterReplacement:'<paragraph><nota ref="test" o=""/></paragraph>note<abstract.summary></abstract.summary>'
    ...
    client: {
        ...
        gulf:{
            ...
            replace: 'Replace',
            oldxmltext:'<text final="" lang="eng"><unit><unit code="" part="" complement=""><group><group-text><title><title-section unit="" part="" complement=""/><title-text></title-text></title><paragraph></paragraph></group-text></group></unit></unit></text>',
            expectedXmlAfterReplacement : '<original-highlight text-effect="overline"><nota ref="test" o=""/></original-highlight>note<abstract.summary></abstract.summary>',
